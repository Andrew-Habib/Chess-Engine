...
extern int pop_count(Bitboard x); // Changed by me
extern int sparse_pop_count(Bitboard x); // Changed by me
extern Square pop_lsb(Bitboard* b); // Changed by me

extern const int DEBRUIJN64[64];
extern const Bitboard MAGIC;
extern Square bsf(Bitboard b); // Changed by me
