...
#include "types.h"
#include <iostream>
#include <string.h> // Changed by me
...
Bitboard get_rook_attacks(Square square, Bitboard occ) { // Changed by me
...
//the magic lookup table
Bitboard get_bishop_attacks_for_init(Square square, Bitboard occ) { // Changed by me
